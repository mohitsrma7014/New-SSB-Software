          ...
          <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            <li className="nav-item">
              ...
              <ul className="submenu">
                <li><a href="/DispatchList1">List</a></li>
            ...
            <li className="nav-item">
              <a href="#">Add</a>
              <ul className="submenu">
              <li><a href="/DispatchForm">Add New Dispatch</a></li>
              <li><a href="/Master_list_list3">Component Master</a></li>
              <li><a href="/BatchTrackingTable9">See Batch</a></li>
              </ul>
            </li>
          </ul>
