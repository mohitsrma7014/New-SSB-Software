        ...
        <nav className="navbar">
          ...
          <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            <li className="nav-item">
              ...
              <li><a href="/UIDGenerator">Generate Uid</a></li>
              <li><a href="/Calibrationqa">Calibration Management</a></li>
              <li><a href="/CalibrationRejected"> Rejected Instruments</a></li>
              </ul>
            </li>
            ...
            <li className="nav-item">
              <a href="#">Customer</a>
              <ul className="submenu">
              <li><a href="/CustomerComplaint1">Customer Complaint</a></li>
            ...
            <li className="nav-item">
              ...
              <ul className="submenu">
              <li><a href="/Master_list_listqa">Master List</a></li>
