...
const marking_form = () => {
  ...
  const lineOptions = ["Kamal", "Anil", "Anoop","Sandeep","Sorav","Chetan","Mahaveer","Deendyal","Satish","Shyamu","Keshav","Guddu","Manoj","Vinod"]; // Dropdown options for line
  ...
  return (
    <div className="w-full p-6 bg-white shadow-md rounded-lg mt-20">
      <Sidebar /> 
      <h1 className="text-2xl font-semibold text-gray-700 mb-6">Add Marking Data</h1>
