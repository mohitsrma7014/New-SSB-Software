          ...
          <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            <li className="nav-item">
              ...
              <ul className="submenu">
                <li><a href="/Htanalytics1">Production</a></li>
            ...
            <li className="nav-item">
              <a href="#">Data</a>
              <ul className="submenu">
              <li><a href="/Ht_list">Edit</a></li>
                <li><a href="/BulkAddFormheattreatment">Ht form</a></li>
                <li><a href="/Shot_blast_form">Shot Blast</a></li>
                <li><a href="/Pre_mc_form">Pre M/C</a></li>
                <li><a href="/BatchTrackingTable3">See Batch</a></li>
