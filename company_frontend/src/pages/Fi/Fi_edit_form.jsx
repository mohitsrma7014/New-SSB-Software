  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.id) {
        // Update record
        await axios.put(
          `http://192.168.1.199:8001/fi/FiViewSet/${formData.id}/`,
          formData
        );
      } else {
        // Create new record
        await axios.post(
          "http://192.168.1.199:8001/fi/FiViewSet/",
          formData
        );
      }
      ...
      <div className="bg-white p-6 rounded-lg w-full max-w-7xl shadow-lg overflow-y-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-7 gap-6">
            ...
            <div className="mb-4">
              <label className="block font-medium">Chaker:</label>
              <input
                type="text"
                name="chaker"
            ...
            <div className="mb-4">
              <label className="block font-medium">Rust:</label>
              <input
                type="number"
                name="rust"
                value={formData.rust}
