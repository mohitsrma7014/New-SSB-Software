          ...
          <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            <li className="nav-item">
              ...
              <ul className="submenu">
                <li><a href="/Cnc_production1">Production</a></li>
                <li><a href="/CncDashboard">Rejection Report</a></li>
              </ul>
            </li>
           
            <li className="nav-item">
              <a href="#">Data</a>
              <ul className="submenu">CncDashboard
              <li><a href="/Cnc_list">Edit</a></li>
                <li><a href="/BulkAddFormcnc">CNC form</a></li>
                <li><a href="/BatchTrackingTable5">See Batch</a></li>
                <li><a href="/CncPlanningList">Planning Updates</a></li>
                
                <li><a href="/Master_list_list2">Component Master List</a></li>
                <li><a href="/LineMaster">Line Master List</a></li>
              </ul>
            </li>
          </ul>
