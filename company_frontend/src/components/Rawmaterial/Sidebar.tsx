          ...
          <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            <li className="nav-item">
              ...
              <ul className="submenu">
                <li><a href="/BalanceAfterHold">RM Stock</a></li>
            ...
            <li className="nav-item">
              ...
              <li><a href="/Orders">RM Order Managment</a></li>
                ...
                <li><a href="/BlockmtForm_dummy">Planning Cheq</a></li>
                
                <li><a href="/Issu">Material Issuance</a></li>
                
                <li><a href="/Single">Master Data Management</a></li>
            ...
            <li className="nav-item">
              <a href="#">Data</a>
              <ul className="submenu">
                <li><a href="/Raw_material_update">Material Information System (MIS)</a></li>
                <li><a href="/Issu_list">Material Issuance List</a></li>
                <li><a href="/Planning_updates">Updates & Running Batchs</a></li>
                <li><a href="/PlanningUpdates1">Batch List</a></li>
                <li><a href="/Master_list_list1">Master list</a></li>
                <li><a href="/Rm_schedule">Customer Schedules</a></li>
              </ul>
            </li>
          </ul>
