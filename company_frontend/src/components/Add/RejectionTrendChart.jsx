...
// API Endpoint
const apiEndpoint = 'http://192.168.1.199:8001/forging/api/rejection-trend/';
...
const RejectionTrendChart = () => {
  ...
  return (
    <div className=" mx-auto mt-24 ml-2 bg-white rounded-xl shadow-lg  hover:shadow-2xl duration-300">
