...
urlpatterns = [
    ...
    path('ForgingViewSet1/', ForgingViewSet1.as_view({'get': 'list', 'post': 'create'}), name='ForgingViewSet'),
    path('ForgingViewSet1/<int:pk>/', ForgingViewSet1.as_view({'put': 'update', 'delete': 'destroy'}), name='forging-detail'),
